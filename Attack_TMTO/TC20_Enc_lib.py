...
def Enc_Round(in_state, rkey):
    ...
    out_state2 = SB(out_state1)
    out_state3 = LM(out_state2)
    
    return out_state3

#-- TC20 Encryption
def TC20_Enc(input_state, key):
    state = input_state
    numRound = 10 # 라운드 수
...
def main():
    ...
    for i in range(0,255):
        round_out=[]
        round_out = Enc_Round([23,23,23,23],[167,i,106,i])
        print(i,round_out)
        i = i+1
        if round_out[1] == 0:
            break
    ...
    # in_state = [21,21,21,21]
    # round_out = Enc_Round(in_state,rkey)
    # print(round_out)
